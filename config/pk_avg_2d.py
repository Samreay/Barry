...
if __name__ == "__main__":
    ...
    for r in [False]:
        ...
        fitter.add_model_and_dataset(model, d, name=f"Beutler 2017 {t}", linestyle=ls, color=cs[0])
        fitter.add_model_and_dataset(model_marg, d, name=f"Beutler 2017 {t}", linestyle=ls, color=cs[3])
