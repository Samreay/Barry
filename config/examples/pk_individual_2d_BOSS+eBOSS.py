...
if __name__ == "__main__":
    ...
    datasets = [
        PowerSpectrum_SDSS_DR12(
            redshift_bin=1, galactic_cap="ngc", recon="iso", isotropic=False, fit_poles=[0, 2, 4], min_k=0.01, max_k=0.30, num_mocks=999
        ),
        PowerSpectrum_SDSS_DR12(
            redshift_bin=1, galactic_cap="sgc", recon="iso", isotropic=False, fit_poles=[0, 2, 4], min_k=0.01, max_k=0.30, num_mocks=999
        ),
        PowerSpectrum_SDSS_DR12(
            redshift_bin=2, galactic_cap="ngc", recon="iso", isotropic=False, fit_poles=[0, 2, 4], min_k=0.01, max_k=0.30, num_mocks=999
        ),
        PowerSpectrum_SDSS_DR12(
            redshift_bin=2, galactic_cap="sgc", recon="iso", isotropic=False, fit_poles=[0, 2, 4], min_k=0.01, max_k=0.30, num_mocks=999
        ),
