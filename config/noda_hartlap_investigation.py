...
if __name__ == "__main__":
    ...
    for r in [True, False]:
        ...
        data1 = PowerSpectrum_SDSS_DR12_Z061_NGC(recon=r, min_k=0.03, max_k=0.30, postprocess=postprocess, apply_correction=True)
        data2 = PowerSpectrum_SDSS_DR12_Z061_NGC(recon=r, min_k=0.03, max_k=0.30, postprocess=postprocess, apply_correction=False)
