...
if __name__ == "__main__":
    ...
    for r in [True, False]:
        ...
        d = PowerSpectrum_SDSS_DR12_Z061_NGC(name=f"SDSS {t}", recon=r, realisation=0)
        de = PowerSpectrum_SDSS_DR12_Z061_NGC(name=f"SDSS {t}", recon=r, postprocess=p, realisation=0)
