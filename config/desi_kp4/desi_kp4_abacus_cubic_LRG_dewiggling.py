...
from barry.cosmology.power_spectrum_smoothing import get_smooth_methods_list
...
if __name__ == "__main__":
    ...
    for dewiggle in get_smooth_methods_list():
        ...
        for j in range(len(dataset_pk.mock_data)):
            ...
            name = dataset_pk.name + f" realisation {j} dewiggle=" + str(dewiggle)
            fitter.add_model_and_dataset(model, dataset_pk, name=name)
        ...
        for j in range(len(dataset_xi.mock_data)):
            ...
            name = dataset_xi.name + f" realisation {j} dewiggle=" + str(dewiggle)
            fitter.add_model_and_dataset(model, dataset_xi, name=name)
