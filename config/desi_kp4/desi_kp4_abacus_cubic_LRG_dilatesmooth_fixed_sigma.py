...
if __name__ == "__main__":
    ...
    for dilate_smooth in [True, False]:
        ...
        for n, (broadband_type, n_poly) in enumerate(zip(["poly", "spline"], [[-1, 0, 1, 2, 3], 30])):
            ...
            model.set_default("sigma_nl_par", sigma[recon][0])
            model.set_default("sigma_nl_perp", sigma[recon][1])
            model.set_default("sigma_s", sigma[recon][2])
