...
class MockIndividualPowerSpectrum(Dataset):
    def __init__(self, realisation=0, min_k=0.02, max_k=0.30, step_size=2, recon=True, reduce_cov_factor=1, name="MockAveragePK"):
        super().__init__(name)
    ...
    def _load_winfit(self, winfit_file):
        ...
        self.w_mask = np.array([x in self.ks for x in self.w_ks_output])
...
if __name__ == "__main__":
    ...
    MockAveragePowerSpectrum(step_size=2)
