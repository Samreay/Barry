...
class PowerNoda2019(PowerSpectrumFit):
    ...
    def __init__(self, fix_params=["om", "f", "gamma"], gammaval=4.0, smooth_type="hinton2017", recon=False, recon_smoothing_scale=21.21, name="Pk Noda 2019", postprocess=None):
        self.recon = recon
