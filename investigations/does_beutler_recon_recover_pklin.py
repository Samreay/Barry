...
if __name__ == "__main__":
    ...
    from barry.datasets import PowerSpectrum_SDSS_DR12_Z061_NGC, DummyPowerSpectrum_SDSS_DR12_Z051_NGC
    dataset1 = PowerSpectrum_SDSS_DR12_Z061_NGC(recon=recon)
    dataset2 = DummyPowerSpectrum_SDSS_DR12_Z051_NGC(name="Dummy data, real window fn", dummy_window=False)
    dataset3 = DummyPowerSpectrum_SDSS_DR12_Z051_NGC(name="DummyWindowFnToo", dummy_window=True)
